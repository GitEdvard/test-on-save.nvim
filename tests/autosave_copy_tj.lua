...
local group = vim.api.nvim_create_augroup("edvard-test-run", { clear = true })

local make_key = function(state, entry)
...
local attach_to_buffer = function(bufnr, command)
    ...
    vim.api.nvim_create_user_command(bufnr, "GoTestLineDiag", function()
        ...
        callback = function()
            ...
            vim.fn.jobstart(command, {
                ...
                on_exit = function()
                    ...
                    vim.diagnostic.set(nw, bufnr, failed, {})
                end,
            })
        end,
    })
